...
group = "org.example.opensavvylazylayoutstest"
...
kotlin {
    ...
    configAsKobwebApplication("opensavvylazylayoutstest" /*, includeServer = true*/)
    ...
    sourceSets {
        ...
        jsMain.dependencies {
            ...
            implementation(libs.opensavvy.lazy.layouts)
        }
